...
def main():
    ...
    with open(file_name, "w") as file:
        file.write("Time period:", date_list[0] + "-" + date_list[-1])
        file.write("Total minutes:", total)
        file.write("Average minutes:", total / n_days)
        for index in range(n_days):
            file.write(date_list[index], minutes_list[index])
